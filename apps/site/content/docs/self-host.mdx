---
title: Self-host
description: Self-host OfferKit with the published container image on Docker or Railway, configure Postgres and Redis, and verify the application and worker.
---
